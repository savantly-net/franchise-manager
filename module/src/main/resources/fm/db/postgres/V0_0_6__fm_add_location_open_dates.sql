...
(
    ...
    location_open_dates_item_id character varying(42) NOT NULL,
    location_open_dates_tenant_id character varying(255) NOT NULL,
    CONSTRAINT fm_location_fm_location_open_dates_pkey PRIMARY KEY (franchiselocation_item_id, franchiselocation_tenant_id, location_open_dates_item_id, location_open_dates_tenant_id),
    CONSTRAINT fm_location_fm_location_open_dates_uk UNIQUE (location_open_dates_item_id, location_open_dates_tenant_id),
    CONSTRAINT fm_location_fm_location_open_dates_location_fk FOREIGN KEY (franchiselocation_tenant_id, franchiselocation_item_id)
        ...
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT fm_location_fm_location_open_dates_dates_fk FOREIGN KEY (location_open_dates_item_id, location_open_dates_tenant_id)
